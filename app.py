...
def search_transactions():
    if request.method == 'POST':
        ...
        filtered_transactions = [transaction for transaction in transactions if min_amount <= float(transaction['amount']) <= max_amount]
...
def total_balance():
    ...
    return {'Total balance': transaction_sum}
